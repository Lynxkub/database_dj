...
from forms import SongForm, NewSongForPlaylistForm, PlaylistForm
...
def show_playlist(playlist_id):
    ...
    id = playlist.id
    playlist_songs = PlaylistSong.query.filter(PlaylistSong.playlist_id == playlist_id)
...
def add_song():
    ...
    return render_template('songs_form.html', form = form)
